...
gulp.task('awesomecss', function() {
	return gulp.src('app/assets/css/font-awesome.min.css')
		.pipe(gulp.dest('dist/css'))
})
...
gulp.task('scripts', function (){
	return gulp.src(['app/assets/js/common.js', 'app/assets/libs/**/*.js'])
	.pipe(browserSync.reload({stream:true}))
});
...
gulp.task('watch', function() {
	...
	gulp.watch(['app/assets/js/common.js', 'app/assets/libs/**/*.js'], gulp.parallel('scss'));
});
